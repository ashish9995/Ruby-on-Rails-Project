...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { content: @inquiry.content, house_id: @inquiry.house_id, subject: @inquiry.subject, user_id: @inquiry.user_id } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { content: @inquiry.content, house_id: @inquiry.house_id, subject: @inquiry.subject, user_id: @inquiry.user_id } }
