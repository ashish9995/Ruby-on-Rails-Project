...
class RealtorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create realtor" do
    assert_difference('Realtor.count') do
      post realtors_url, params: { realtor: { company_id: @realtor.company_id, first_name: @realtor.first_name, last_name: @realtor.last_name, phone_number: @realtor.phone_number, user_id: @realtor.user_id } }
    end
  ...
  test "should update realtor" do
    patch realtor_url(@realtor), params: { realtor: { company_id: @realtor.company_id, first_name: @realtor.first_name, last_name: @realtor.last_name, phone_number: @realtor.phone_number, user_id: @realtor.user_id } }
